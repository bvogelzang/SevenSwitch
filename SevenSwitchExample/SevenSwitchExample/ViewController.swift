...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        mySwitch2.addTarget(self, action: #selector(switchChanged), for: UIControlEvents.valueChanged)
        ...
        mySwitch3.addTarget(self, action: #selector(switchChanged), for: UIControlEvents.valueChanged)
